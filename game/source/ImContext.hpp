...
public:
	...
	explicit ImContext(ImGuiContext& context, ImPlotContext& plotCtx, f32vec2 const& size, i32vec2 const& windowSize,
	                   i32vec2 const& framebufferSize);

	explicit ImContext(ImGuiContext& context, ImPlotContext& plotCtx, i32vec2 const& size);
